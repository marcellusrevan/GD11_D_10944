package com.test.gd8_d_0944.adapters
...
import com.test.gd8_d_0944.AddEditActivity
import com.test.gd8_d_0944.MainActivity
import com.test.gd8_d_0944.R
...
class MahasiswaAdapter (private var mahasiswaList: List<Mahasiswa>, context: Context):
    ...
    override fun onBindViewHolder(holder: ViewHolder,postion: Int) {
        val mahasiswa = filteredMahasiswaList[postion]
